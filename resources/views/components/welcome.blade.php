<div
    class="p-6 lg:p-8 bg-white dark:bg-zinc-800 dark:bg-gradient-to-bl dark:from-zinc-700/50 dark:via-transparent border-b border-zinc-200 dark:border-zinc-700">
    ...
    <div>
        ...
        <p class="mt-4 text-sm">
            <a href="https://laravel.com/docs"
                class="inline-flex items-center font-semibold text-violet-700 dark:text-violet-300">
                Explore the documentation

                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    class="ml-1 w-5 h-5 fill-violet-500 dark:fill-violet-200">
